    ...
    <div class="panel panel-default">
        ...
        <form action="{{url('/search-product-admin')}}" method="post">
          ...
          <div class="col-sm-3">
            <div class="input-group">
              <input type="text" class="input-sm form-control" name="search_product_page_admin" placeholder="Bạn muốn tìm gi ?">
      ...
      <div class="table-responsive">
        <table class="table table-striped b-t b-light">
          ...
          <tbody>
          @foreach ($result_search_product_page_admin as $item)
            <tr>
